...
4.Demonstração do uso de template string (uso de crases) para facilitar a concatenação de valores das propriedades 
com outras strings.
5.Esclarecimento de que, apesar de ser uma constante (const), é possível modificar o conteúdo das propriedades 
do objeto.
6.Diferença entre modificar uma propriedade do objeto e atribuir um novo objeto à variável, ressaltando que a 
